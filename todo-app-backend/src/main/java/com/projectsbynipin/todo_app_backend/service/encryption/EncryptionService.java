...
public class EncryptionService {
    ...
    private String encryptToken(String token) {
        try {
            ...
            throw new FailedToEncryptJwtRefreshTokenException(Constants.Jwt.FAILED_TO_ENCRYPT_TOKEN, e);
        }
    }
    ...
    private String decryptToken(String encryptedToken) {
        try {
            ...
            throw new FailedToDecryptJwtRefreshTokenException(Constants.Jwt.FAILED_TO_DECRYPT_TOKEN, e);
        }
    }
